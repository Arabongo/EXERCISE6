...
public class Main {
    ...
    private static void exercise2() {
        ...
        int valueA = 5;
        int valueB = 10;
        int maxNumber = Math.max(valueA,valueB);
        int minNumber = Math.min(valueA,valueB);
    ...
    private static void exercise3() {
        ...
        int totalMoney = 50;
        int costPerBurger = 9;
        int remaining = totalMoney % costPerBurger;
